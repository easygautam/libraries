...
android {
    ...
    defaultConfig {
        ...
        // Min SDK support
        minSdkVersion(Libraries.Permission.Sdk.MIN_API)

        // Target sdk version
        targetSdkVersion(Libraries.Permission.Sdk.TARGET_API)

        // Version code
        versionCode = Libraries.Permission.Version.code

        // Version name
        versionName = Libraries.Permission.Version.name
