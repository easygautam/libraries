...
android {
    ...
    defaultConfig {
        ...
        // Min SDK support
        minSdkVersion(Libraries.Core.Sdk.MIN_API)

        // Target sdk version
        targetSdkVersion(Libraries.Core.Sdk.TARGET_API)

        // Version code
        versionCode = Libraries.Core.Version.code

        // Version name
        versionName = Libraries.Core.Version.name
